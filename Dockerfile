...
ADD imports/bin/setup /usr/local/bin/setup/1518817161
ADD imports/bin/config /usr/local/bin/config/1518817161
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518817161 1>/dev/stdout 2>/dev/stderr
