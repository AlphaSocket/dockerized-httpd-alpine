...
ADD imports/bin/setup /usr/local/bin/setup/1519352159
ADD imports/bin/config /usr/local/bin/config/1519352159
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519352159 1>/dev/stdout 2>/dev/stderr
