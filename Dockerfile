...
ADD imports/bin/setup /usr/local/bin/setup/1518873671
ADD imports/bin/config /usr/local/bin/config/1518873671
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518873671 1>/dev/stdout 2>/dev/stderr
