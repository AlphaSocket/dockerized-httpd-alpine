...
ADD imports/bin/setup /usr/local/bin/setup/1519093145
ADD imports/bin/config /usr/local/bin/config/1519093145
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519093145 1>/dev/stdout 2>/dev/stderr
