...
ADD imports/bin/setup /usr/local/bin/setup/1519007325
ADD imports/bin/config /usr/local/bin/config/1519007325
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519007325 1>/dev/stdout 2>/dev/stderr
