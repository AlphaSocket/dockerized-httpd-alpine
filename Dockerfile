...
ADD imports/bin/setup /usr/local/bin/setup/1519352157
ADD imports/bin/config /usr/local/bin/config/1519352157
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519352157 1>/dev/stdout 2>/dev/stderr
