...
ADD imports/bin/setup /usr/local/bin/setup/1519092228
ADD imports/bin/config /usr/local/bin/config/1519092228
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519092228 1>/dev/stdout 2>/dev/stderr
