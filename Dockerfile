...
ADD imports/bin/setup /usr/local/bin/setup/1519170393
ADD imports/bin/config /usr/local/bin/config/1519170393
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519170393 1>/dev/stdout 2>/dev/stderr
