...
ADD imports/bin/setup /usr/local/bin/setup/1518873480
ADD imports/bin/config /usr/local/bin/config/1518873480
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518873480 1>/dev/stdout 2>/dev/stderr
