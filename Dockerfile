...
ADD imports/bin/setup /usr/local/bin/setup/1518818219
ADD imports/bin/config /usr/local/bin/config/1518818219
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518818219 1>/dev/stdout 2>/dev/stderr
