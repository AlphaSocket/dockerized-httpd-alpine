...
ADD imports/bin/setup /usr/local/bin/setup/1519404273
ADD imports/bin/config /usr/local/bin/config/1519404273
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519404273 1>/dev/stdout 2>/dev/stderr
