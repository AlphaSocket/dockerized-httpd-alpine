...
ADD imports/bin/setup /usr/local/bin/setup/1519349581
ADD imports/bin/config /usr/local/bin/config/1519349581
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519349581 1>/dev/stdout 2>/dev/stderr
