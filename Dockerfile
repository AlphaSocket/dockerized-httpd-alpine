...
ADD imports/bin/setup /usr/local/bin/setup/1518912436
ADD imports/bin/config /usr/local/bin/config/1518912436
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518912436 1>/dev/stdout 2>/dev/stderr
