...
ADD imports/bin/setup /usr/local/bin/setup/1519077089
ADD imports/bin/config /usr/local/bin/config/1519077089
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519077089 1>/dev/stdout 2>/dev/stderr
