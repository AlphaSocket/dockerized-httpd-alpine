...
ADD imports/bin/setup /usr/local/bin/setup/1518873570
ADD imports/bin/config /usr/local/bin/config/1518873570
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518873570 1>/dev/stdout 2>/dev/stderr
