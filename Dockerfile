...
ADD imports/bin/setup /usr/local/bin/setup/1518896793
ADD imports/bin/config /usr/local/bin/config/1518896793
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518896793 1>/dev/stdout 2>/dev/stderr
